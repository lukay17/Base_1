...
public class CustomToast extends Toast {
    ...
    public static Toast makeText(@NonNull Context context, int duration, int type, @Nullable String message) {
        ...
        LinearLayout llToastBg = customLayout.findViewById(R.id.ll_custom_toast);
    ...
    public static Toast Error(@NonNull Context context, @NonNull String message, int shouldShowIcon) {
        Toast toast = new Toast(context);
        toast.setDuration(Toast.LENGTH_SHORT);
